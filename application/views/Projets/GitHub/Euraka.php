    ...
    <div class="container-fluid">
        <div class="col-sm-8 col-sm-offset-2 col-xs-12">
            <p class="text-justify">
                ...
                <img src="<?php echo images() ?>Projets/euraka.png" class="wrap-left">
    ...
    <footer>
        <div class="row">
            <div class="col-sm-6 col-xs-12">
                <a href="<?php echo site_url('Accueil'); ?>" class="btn btn-default col-md-6" ><span class="glyphicon glyphicon-chevron-left"></span>Accueil</a>
            </div>
        </div>
    </footer>
</body>
